    ...
    <div class="banlance bgfff">
        ...
        <div class="order">
            <div class="orderGoods">
                ...
                <!-- <div class="orderDetail">
                    <img src="https://img2.epetbar.com/2012-11/16/65bf479384e7e549e7be65cce572f363.jpg" alt="">
                    <div>
                        <p>壹之选1st Choice 健康成长配方中小型幼犬粮 350g</p>
                        <span>￥31.00</span>
                        <span>0.35kgx1</span>
                    </div> 
                </div>  -->
        ...
        <div class="orderBottom">
            <div>
                ...
                <button @click="getPay">确认支付</button>
            </div>
        </div>
    </div>
</template>
